"""
Windows/Outlook reminder tools for JARVIS.
Alp Ünlü tarafından yapılmıştır — @alppunlu

Reads and creates reminders through Outlook Tasks when available.
"""
...
from integrations.calendar import _run_helper
...
def _permission_message() -> str:
    return (
        "Animsatici erisimi icin Windows'ta Outlook ve pywin32 gerekli. "
